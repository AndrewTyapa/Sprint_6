...
public class MainPageHeaderTest {
    ...
    public MainPageHeaderTest(int indexNumber, String expectedAccordionHeader, String expectedAccordionText) {
    ...
    // Логика теста: идем по списку - кликаем на заголовок, ждем загрузки текста, сравниваем текст и заголовок с тестовыми данными. 8 тест FAILED, неверный текст
    @Test
