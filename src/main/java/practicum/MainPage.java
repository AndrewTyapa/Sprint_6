...
public class MainPage {
    ...
    private final By headerOrderButton = By.xpath("(//button[contains(text(), 'Заказать')])[1]");

    // Локатор для кнопки "Заказать" в середине страницы
    private final By middleOrderButton = By.xpath("(//button[contains(text(), 'Заказать')])[2]");
    ...
    private final By scooterImage = By.xpath(".//img[contains(@src, 'blueprint')]");
